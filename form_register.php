                ...
                <form action="register.php" method="post" name="form_register" >
                    <table>
                        ...
                        <tr>
                            <td> Email: </td>
                            <td>
                                <input type="email" name="email" maxlength="100" required="required" /><br />
                                <p class="note_text">Укажите правильный Email, так как на него будет выслано сообщение для подтверждения почты.</p>
